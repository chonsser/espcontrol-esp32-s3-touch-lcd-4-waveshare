...
The 4-inch **Waveshare ESP32-S3-Touch-LCD-4** (board revision 4.0) is also supported with the same 9-card layout as the 4848S040; it is built with ESPHome until pre-built firmware is published.
