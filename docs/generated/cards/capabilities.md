...
| Date & Time | clock | None | Yes | Date & Time (calendar) | Type: clock, datetime, default, timezone; Large Clock; Text size: default, small, medium, large; Clock font: default, thin, bold, mono; Time format; Date format; Date size: default, small, medium, large | Visible |
