...
TASKS = (
    task("firmware-tests", ("cmake", "-E", "remove_directory", "build/tests/firmware"),
         ...
         inputs=(
             ...
             "components/espcontrol/clock_numeric_format.h",
             "components/espcontrol/clock_font_measure.h",
             "components/espcontrol/button_grid_clock_appearance.h",
             "components/espcontrol/button_grid_datetime_cards.h",
             "components/espcontrol/button_grid_date_time_driver.h",
    ...
    task("web-unit", ("node", "--test", "tests/web/unit/**/*.test.js"), profiles=FAST + RELEASE,
         domains=("web",), inputs=("tests/web/unit/**", "tests/web/*.test.ts", "tests/fixtures/screensaver_clock_formats.json", "common/config/clock_appearance_card_normalization_fixtures.json", "src/webserver/**", "product/v2/product_compatibility.json", "compatibility/fixtures/panel_config_migration_v1.json", "devices/manifest.json", "scripts/load_typescript_module.js", "package-lock.json") + WEB_I18N_INPUTS, parallel_safe=True,
         cache_tools=("node",)),
    ...
    task("saved-config-parity", ("node", "scripts/check_saved_config_parity.js"), dependencies=("generated",), profiles=FAST + RELEASE,
         domains=("firmware", "web"), inputs=("components/espcontrol/button_grid_config_parser.h", "components/espcontrol/clock_numeric_format.h", "components/espcontrol/button_grid_card_runtime.h", "components/espcontrol/button_grid_contract_generated.h", "components/espcontrol/button_grid_saved_config_vacuum_generated.h", "common/config/card_normalization_fixtures.json", "common/config/*_card_normalization_fixtures.json", "src/webserver/**", "scripts/check_saved_config_parity.js") + WEB_SOURCE_HELPERS + WEB_BUNDLE_INPUTS,
    ...
    task("web-browser-smoke", ("node", "scripts/check_web_browser_smoke.js"),
         ("node", "tests/web/screen_navigation.browser.js"), ("node", "--test", "tests/web/screen_overview_browser.test.js"), dependencies=("generated", "device-manifest-output"), profiles=("all", "release"),
         domains=("web",), inputs=("src/webserver/**", "devices/**", "common/addon/time.yaml", "scripts/check_web_browser_smoke.js", "tests/web/date_time_text_size_browser.test.js", "tests/web/screensaver_clock_format_browser.test.js", "tests/web/screensaver_hls_browser.test.js", "tests/web/clock_card_appearance_browser.test.js", "tests/web/screen_navigation.browser.js", "tests/web/screen_overview_browser.test.js", "package-lock.json") + WEB_SOURCE_HELPERS + WEB_I18N_INPUTS,
