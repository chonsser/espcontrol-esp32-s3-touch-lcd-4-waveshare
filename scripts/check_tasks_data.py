...
TASKS = (
    ...
    task("web-browser-smoke", ("node", "scripts/check_web_browser_smoke.js"),
         ("node", "tests/web/screen_navigation.browser.js"), dependencies=("generated", "device-manifest-output"), profiles=("all", "release"),
         domains=("web",), inputs=("src/webserver/**", "devices/**", "common/addon/time.yaml", "scripts/check_web_browser_smoke.js", "tests/web/date_time_text_size_browser.test.js", "tests/web/screensaver_clock_format_browser.test.js", "tests/web/clock_card_appearance_browser.test.js", "tests/web/screen_navigation.browser.js", "package-lock.json") + WEB_SOURCE_HELPERS + WEB_I18N_INPUTS,
